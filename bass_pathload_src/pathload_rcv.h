...
//tfang
#define NONE 0
#define SPIKE_PENDING 1
#define SPIKE_VALID 2
#define SPIKE_UP 56  // Lisong: sudden increase to detect a spike
#define SPIKE_DOWN 28  // Liong: decrease of spike to confirm a spike

EXTERN void AverageProbeStream(int spike_begin, int spike_end, double* sendgap, double* recvgap);
EXTERN void SpikeRemoval(double* sendgap, double* recvgap, int N);
